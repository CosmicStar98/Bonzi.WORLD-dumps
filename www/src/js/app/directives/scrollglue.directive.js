...
(function(angular, undefined) {
  ...
  function createDirective(attrName, direction) {
    angular.module('app.directives')
      .directive(attrName, ['$parse', '$window', '$timeout', function($parse, $window, $timeout) {
        return {
          priority: 1,
          restrict: 'A',
  ...
  createDirective('scrollGlueTop', top);
  createDirective('scrollGlueBottom', bottom);
  createDirective('scrollGlueLeft', left);
  createDirective('scrollGlueRight', right);
}(angular));
